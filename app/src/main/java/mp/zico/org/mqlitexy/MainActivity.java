...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for(HashMap<String, String> record:userList){
            System.out.println("===userId==="+record.get("userId"));
        }
...
//        client.post("http://192.168.2.4:9000/mysqlsqlitesync/getusers.php", params, new AsyncHttpResponseHandler() {
        client.post("https://mysqlsqlitesync.babytaby.com/mqlitexy/getusers.php", params, new AsyncHttpResponseHandler() {
        ...
        try {
            ...
            if(arr.length() != 0){
                ...
                for (int i = 0; i < arr.length(); i++) {
                   ...
                   // controller.deleteTable(queryValues);
                    controller.insertUser(queryValues);
                    HashMap<String, String> map = new HashMap<String, String>();
                    // Add status for each User in Hashmap
                    map.put("X", obj.get("userId").toString());
                    map.put("status", "1");
...
//        client.post("http://192.168.2.4:9000/mysqlsqlitesync/updatesyncsts.php", params, new AsyncHttpResponseHandler() {
        client.post("https://mysqlsqlitesync.babytaby.com/mqlitexy/updatesyncsts.php", params, new AsyncHttpResponseHandler() {
            @Override
            public void onSuccess(String response) {
